...
AUTHORS HOME PAGE http://localhost:3000/author/home
READERS HOME PAGE http://localhost:3000/reader/reader-home
You can then navigate easily from those starting points to the other parts of the page.
